...
{
//      std::cout << "downheaping index  " << index << "\n";
//      std::cout << "content[index] = " << content[index] <<"\n";
      int temp;
      if( (content[(5*index) +1]<content[index]) && ( ((5*index)+1)<lastElementIndex) )
      {
            temp=content[index];
      ...
      else if( (content[(5*index) +2]<content[index]) && ( ((5*index)+2)<lastElementIndex) )
      {
            temp=content[index];
      ...
      else if( (content[(5*index) +3]<content[index]) && ( ((5*index)+3)<lastElementIndex) )
      {
            temp=content[index];
      ...
      else if( (content[(5*index) +4]<content[index]) && ( ((5*index)+4)<lastElementIndex) )
      {
            temp=content[index];
